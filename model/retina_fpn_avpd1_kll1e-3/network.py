...
from det_oprs.retina_anchor_target import retina_avpd1_anchor_target
...
class RetinaNet_Criteria(nn.Module):
    ...
    def __call__(self, pred_cls_list, pred_reg_list, anchors_list, gt_boxes, im_info):
        all_anchors = torch.cat(anchors_list, axis=0).repeat(config.train_batch_per_gpu, 1)
        ...
        labels, bbox_target = retina_avpd1_anchor_target(all_avpd_anchors, all_anchors, gt_boxes, im_info, top_k=1)
