...
class RetinaNet_Criteria(nn.Module):
    ...
    def __call__(self, pred_cls_list, pred_var_cls_list, pred_refined_cls_list, 
        ...
        loss_dict['var_positive_bag_loss'] = var_loss_dict['positive_bag_loss']
        loss_dict['var_negative_bag_loss'] = var_loss_dict['negative_bag_loss']
...
class RetinaNet_Head(nn.Module):
    def __init__(self):
        ...
        torch.nn.init.constant_(self.varcls_pred[-1].bias, bias_value)
