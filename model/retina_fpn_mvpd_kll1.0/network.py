...
from det_oprs.retina_anchor_target import retina_anchor_target_m1vpd
...
class RetinaNet_Criteria(nn.Module):
    ...
    def __call__(self, pred_cls_list, pred_reg_list, anchors_list, gt_boxes, im_info):
        ...
        # get ground truth
        labels, bbox_target, overlap_bbox_target = retina_anchor_target_m1vpd(all_anchors, gt_boxes, im_info, top_k=1)
        # regression loss
