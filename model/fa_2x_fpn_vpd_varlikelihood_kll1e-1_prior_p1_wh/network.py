...
from det_oprs.my_loss_opr import freeanchor_vvpd_loss
...
class RetinaNet_Criteria(nn.Module):
    ...
    def __call__(self, pred_cls_list, pred_reg_list, anchors_list, gt_boxes, im_info):
        ...
        # get ground truth
        loss_dict = freeanchor_vvpd_loss(all_anchors, all_pred_cls, all_pred_reg, 
                                        all_pred_lstd, gt_boxes, im_info)
