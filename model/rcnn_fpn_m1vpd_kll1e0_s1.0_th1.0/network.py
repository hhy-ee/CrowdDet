...
class Network(nn.Module):
    ...
    def _forward_train(self, image, im_info, gt_boxes):
        ...
        rcnn_rois, rcnn_labels, rcnn_bbox_targets, rcnn_std_targets = fpn_roi_target_mvpd(
...
class RCNN(nn.Module):
    ...
    def forward(self, fpn_fms, rcnn_rois, labels=None, bbox_targets=None, std_targets=None):
        ...
        if self.training:
            ...
            pred_mean = pred_mean[fg_masks, fg_gt_classes, :]
            pred_lstd = pred_lstd[fg_masks, fg_gt_classes, :]
