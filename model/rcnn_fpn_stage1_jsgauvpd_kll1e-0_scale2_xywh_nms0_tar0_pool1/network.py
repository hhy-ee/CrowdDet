...
class Network(nn.Module):
    ...
    def _forward_train(self, image, im_info, gt_boxes):
        ...
        rcnn_rois, rcnn_vpd_rois, rcnn_labels, rcnn_bbox_targets, rcnn_bbox_vpd_targets \
            = fpn_roi_target_vpd(rpn_rois, rpn_rois_vpd, im_info, gt_boxes, top_k=1)
        loss_dict_rcnn = self.RCNN(fpn_fms, rcnn_vpd_rois, 
