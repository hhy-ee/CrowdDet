...
class Crowd_human:
    ...
    root_folder = os.path.join(root_dir, 'data/HIE20')
    image_folder = os.path.join(root_dir, 'data/HIE20/Images')
    train_source = os.path.join(root_dir, 'data/HIE20/annotation_train.odgt')
    eval_source = os.path.join(root_dir, 'data/HIE20/annotation_val.odgt')
