...
class Network(nn.Module):
    ...
    def forward(self, image, im_info, epoch=None, gt_boxes=None):
        ...
        pred_cls_list, pred_ref_cls_list, pred_reg_list = self.R_Head(fpn_fms)
        ...
        if self.training:
            ...
            pred_bbox = per_layer_inference(
                    anchors_list, pred_ref_cls_list, pred_reg_list, im_info)
...
class RetinaNet_Criteria(nn.Module):
    ...
    def __call__(self, pred_cls_list, pred_ref_cls_list, 
        ...
        ref_loss_dict = freeanchor_loss(all_anchors, all_pred_ref_cls, all_pred_reg, gt_boxes, im_info)
        loss_kld = kldiv_loss(
                all_pred_mean,
                all_pred_lstd,
                config.kl_weight)
...
class RetinaNet_Head(nn.Module):
    ...
    def forward(self, features):
        ...
        pred_reg_list = [
            ...
            for _ in pred_reg]
        return pred_cls_list, pred_ref_cls_list, pred_reg_list
