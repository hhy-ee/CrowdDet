...
from det_oprs.find_top_rpn_proposals import find_top_rpn_proposals_fa
...
from det_oprs.my_loss_opr import rpn_fa_loss
...
class RPN(nn.Module):
    ...
    def forward(self, features, im_info, boxes=None):
        ...
        rpn_rois = find_top_rpn_proposals_fa(
        ...
        if self.training:
            ...
            loss_dict = rpn_fa_loss(all_anchors, all_pred_cls, all_pred_reg, boxes, im_info)
